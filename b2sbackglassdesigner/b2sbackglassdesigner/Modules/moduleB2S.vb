...
Module moduleB2S
    ...
    Public Const AppTitle As String = "B2S Backglass Designer v1.26"
    ...
    Public Function IsFontInstalled(fontName As String) As Boolean
        Using testFont = New Font(fontName, 8)
            Return 1 = String.Compare(fontName, testFont.Name, StringComparison.InvariantCultureIgnoreCase)
        End Using
    End Function
